...
<Content>
  <Container>
    ...
    <Row className="align-items-center justify-content-center freelancer-alt-card">
      ...
      <Col  className="col-xl-7 col-lg-7 col-md-7 col-xs-7 order-1 order-lg-1">
        <Content.Image className="image-card2">
          <img src="image/it-services/dashboard.png"  alt="content" className="resp-image main-img1"/>
        </Content.Image>
      </Col>
      <Col xs="12" className="col-xl-5 col-lg-5 col-md-5 col-xs-5 order-2 order-lg-2 ">
    ...
    <div className=" d-flex alt-card2 main-container">
      ...
      <Col xs="12" className="col-xl-6 col-lg-6 col-md-6 col-xs-6 order-1 order-lg-2">
        <Content.Image className="image-card3">
          <img src="image/it-services/invites.png"  alt="content" className="resp-image main-img2"/>
        </Content.Image>
      </Col>
    </div>
    </Row>
    ...
    <Row className="align-items-center justify-content-center freelancer-alt-card">
    <div className=" d-flex main-container">
      <Col xs="12" className="col-xl-7 col-lg-7 col-md-7 col-xs-7 order-1 order-lg-1">
        <Content.Image className="image-card4">
          <img src="image/it-services/get-paid.png"  alt="content" className="resp-image main-img4"/>
        </Content.Image>
      </Col>
      <Col className="col-xl-5 col-lg-5 col-md-5 col-xs-5 order-2 order-lg-2 ">
        <Content.Box className="txt-card4">
        <SectionTitle title="Get Paid" title2="Securely" text="Rest assured that all payments are securely transferred to your account. We handle all billing and invoicing directly with clients, so you can focus on more important tasks. Get paid on time, every time!"
        titleProps={{mb:"10px",as:"h2"}}
        mb="69px" />
        </Content.Box>
      </Col>
    ...
    <div className=" d-flex">
      ...
      <Col xs="12" className="col-xl-5 col-lg-5 col-md-5 col-xs-5 order-1 order-lg-2">
        <Content.Image className="image-card5">
          <img src="image/it-services/proof.png"  alt="content" className="resp-image main-img5"/>
        </Content.Image>
      </Col>
    </div>
    </Row>
