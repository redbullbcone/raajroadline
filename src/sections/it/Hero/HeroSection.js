    ...
    <Row className="align-items-center justify-content-center justify-content-md-start">
      ...
      <Col xs="12" className="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-xs-11">
        <div className="welcome-content welcome-content--l3">
          ...
          <Hero.Title>Find the perfect freelance<br className="d-none d-xs-block" />  projects for you!</Hero.Title>
          ...
          <Hero.BtnGroup>
            <Hero.Button className="btn-primary btn-1 text-white" as={Link} to="/">Become a freelancer</Hero.Button>
