        ...
        <Container>
          <Row className="justify-content-center white-image first-business-sec">
            <Col xs="auto" className="col-xxl-6 col-xl-6  col-lg-6  col-md-6 col-xs-6 business-altcard">
              ...
              <a href="/employee-monitoring" className="blue-close" textTransform="capitalized">Learn More</a>
        ...
        <Container>
          <Row className="justify-content-center white-image first-business-sec">
            ...
            <Col xs="auto" className="col-xxl-6 col-xl-6  col-lg-6  col-md-6 col-xs-6 business-altcard">
              ...
              <a  href="/hire-interns" className="blue-close" textTransform="capitalized">Learn More</a> 
              {/* <Content.Button></Content.Button> */}
              </div>
            </Col>
          </Row>
