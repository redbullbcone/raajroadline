        ...
        <Container>
            <Row className="row justify-content-center text-center">
              ...
              <Col xs="6" className="col-6 col-lg-3 col-md-4 col-xs-6">
                <LazyLoad>
                    <Counter.Text className="d-flex flex-column counter-card align-items-center">
                    <img src="image/home-services/get-started-count-2.png" alt="content" />
              ...
              <Col xs="6" className="col-6 col-lg-3 col-md-4 col-xs-6">
                <LazyLoad>
                  <Counter.Text className="d-flex flex-column counter-card align-items-center">
                  <img src="image/home-services/get-started-count-3.png" alt="content" />
              ...
              <Col xs="6" className="col-6 col-lg-3 col-md-4 col-xs-6">
                <LazyLoad>
                  <Counter.Text className="d-flex flex-column counter-card align-items-center">
                  <img src="image/home-services/get-started-count-4.png" alt="content" />
