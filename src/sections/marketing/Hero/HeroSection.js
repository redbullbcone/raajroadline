      ...
      <Hero className="position-relative bg-default">
        <Container>
          <Row>
            ...
            <Col
              className="col-xl-6 col-lg-7 col-md-8 col-xs-11 order-2 order-lg-1 homepage-hero"
              xs="12"
            >
              <Hero.Content>
                ...
                <Hero.Text>
                Join the fastest growing AI-Powered
                ...
                <Row>
                  <Col xs="12" className="col-xxl-10">
                    ...
                    <form className="hero-form d-flex  flex-row justify-content-start">
                      ...
                      <Button className="btn-primary text-white hero-btn1"textTransform="capitalized">Join Now For Free</Button>
                      <Button className="btn-light-blue text-white hero-btn2"textTransform="capitalized">Book a Demo</Button>
                    </form>
                  </Hero.Newsletter>
                  {/* <Hero.NewsletterText>
