        ...
        <Row className="align-items-center justify-content-center">
          <Col className="col-xl-5 col-lg-5 col-md-5 col-xs-12 order-2 order-lg-1">
            <Service.Box className='earn-from-section' >
              ...
              <SectionTitle
                // subTitle="Services"
                title="Earn From <br> Freelancers"
                text="Our marketplace is a great opportunity to share with freelancers looking for a convenient and consistent way to get jobs. By referring them, not only are they rewarded with competitive paying jobs, but you are as well through commission. Immediately start getting rewarded the moment they land a job."
                titleProps={{ mb: "20px" }}
                // subTitleProps={{
                //   mb: "10px",
                //   className: "subline",
