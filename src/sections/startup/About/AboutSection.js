          ...
          <Col className="col-xxl-6 col-lg-6 col-md-6 col-xs-12">
            <About.Box>
              ...
              <About.Content className="para-background-color1">
                <SectionTitle
                  // subTitle="About us"
                  title="Earn from <br> Businesses"
                  text="Top of the list of dreams for many small firms and solo professionals is to win lucrative work with big corporate clients. A few decent projects can keep your business very healthy."
                  // subTitleProps={{
                  //   mb: "10px",
                  //   className: "subline",
                  //   fontColor: "#5034fc",
      ...
      <Container>
        <Row className="align-items-center justify-content-center justify-content-lg-start section-affiliate-alt">
          <Col xs="12" className="col-xl-5 col-lg-5 col-md-5 col-xs-12">
            ...
            <SectionTitle
                      // subTitle="About us"
                      title="Earn From <br> Recruitment Agencies"
                      text="Earn more doing what you have already been doing. All it takes is to send promotional material and links to your network of freelancers. Earn from each freelancer who signs up and successfully gets a job which is done easier with our marketplace automation and AI recommendations."
                      // subTitleProps={{
                      //   mb: "10px",
                      //   className: "subline",
                      //   fontColor: "#5034fc",
          ...
          <Col className="col-xl-7 col-lg-7 col-md-7 col-xs-12">
